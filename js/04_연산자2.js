...
function check1(){
  ...
  console.log(`${num1} == ${num2} => ${num1 == num3}`); // f
...
/* 
  AND(&&) : 둘 다 true인 경우에만 ture (나머진 false)
...
function orCheck(){
  ...
  // 나이가 18세 미만 이거나, 이름이 "김길동"인 경우
  const bool2 = (age < 18) || (name === "김길동")
  console.log(`나이가 18세 미만 이거나, 이름이 "김길동"인 경우 ${bool2}`);
}
